        ...
        child: _Card(title: translate('About MarvaDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.solucionesmarva.com/aviso-de-privacidad/');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.solucionesmarva.com');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} Soluciones Tecnologicas de Infraestructura y Sistemas, SAS de CV\n$license',
