...
fn main() {
    ...
    let matches = App::new("marvadesk")
        .version(crate::VERSION)
        .author("Soluciones Tecnologicas de Infraestructura y Sistemas, SAS de CV <soporte@solucionesmarva.com>")
        .about("MarvaDesk command line tool")
